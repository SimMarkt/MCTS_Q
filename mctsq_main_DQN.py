...
from src.mctsq_config_mcts_V2 import MCTSQConfiguration, MCTS_Q, DQN_Agent
...
def main():
    ...
    if TrainConfig.model_conf != "test_model":
        model = DQN_Agent(env_train, seed=TrainConfig.seed_train, config=MCTSQConfig, log_path=TrainConfig.log_path, tb_log=TrainConfig.tb_path + str_id)
        ...
        if TrainConfig.model_conf == "save_model" or TrainConfig.model_conf == "save_load_model":
            print("Save DQN agent under ./logs/ ... \n") 
